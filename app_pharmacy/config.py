...
# ВАЖНО: Эти веса не обоснованы эмпирически и могут быть неоптимальными.
# Рекомендуется использовать только ML предсказания (use_rule_based=False)
# или оптимизировать веса через валидацию.
POTENTIAL_BLEND = {
    'rule_weight': 0.6,
    'ml_weight': 0.4,
    'use_rule_based': False,  # Можно отключить для использования только ML
}
